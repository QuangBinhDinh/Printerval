...
const EVENT_NAME = 'ask_remove_cart';

const PopupRemoveCart = () => {
        ...
        >
            <View style={styles.container}>
                <Icon
                    ...
                    style={{ marginTop: 24 }}
                />
                <TextNormal style={styles.content}>{'Do you want to delete this item?'}</TextNormal>
...
export default memo(PopupRemoveCart);
